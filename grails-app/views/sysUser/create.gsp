            ...
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="create-sysUser" >
                                        <g:if test="${flash.message}">
                                            <div class="message" role="status">${flash.message}</div>
                                        </g:if>
                                        <g:hasErrors bean="${this.sysUser}">
                                            <ul class="errors" role="alert">
                                                <g:eachError bean="${this.sysUser}" var="error">
                                                    <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                                                </g:eachError>
                                            </ul>
                                        </g:hasErrors>
                                        <g:form class="form-horizontal" resource="${this.sysUser}" method="POST">

                                            <div class="form-group row" >
                                                <f:all bean="sysUser" except="['lastLogin','numberOfPagePrinted']"/>
                                            </div>
