                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="show-sysUser" >
                                    ...
                                    <f:display bean="sysUser" />
                                    <g:form class="form-horizontal" resource="${this.sysUser}" method="DELETE">
                                        <fieldset class="buttons">
                                            <g:link class="btn btn-primary m-b-5 m-t-5" action="edit" resource="${this.sysUser}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
