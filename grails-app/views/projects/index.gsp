...
<html>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <f:table id="projectsTable"  collection="${projectsList}" except="['id','isActive']"/>
                        %{--<div class="pagination">
                            <g:paginate total="${projectsCount ?: 0}" />
                        </div>--}%
    ...
    <script type="application/javascript">
        var url = '/projects/data_for_datatable';
                ...
                "columns": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<a href="/projects/show/' + row.id + '">' + data + '</a>';
                        }
                    },
                    {"data": "projectName"},
                    {"data": "projectRole"},
