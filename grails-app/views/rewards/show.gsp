...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'rewards.label', default: 'Rewards')}" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="show-rewards" >
                                    ...
                                    <f:display bean="rewards" />
                                    <g:form class="form-horizontal" resource="${this.rewards}" method="DELETE">
                                        <fieldset class="buttons">
                                            <g:link class="btn btn-primary m-b-5 m-t-5" action="edit" resource="${this.rewards}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
