                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div id="edit-rewards" >
                                ...
                                <g:hasErrors bean="${this.rewards}">
                                <ul class="errors" role="alert">
                                    <g:eachError bean="${this.rewards}" var="error">
                                    <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                                    </g:eachError>
                                </ul>
                                </g:hasErrors>
                                <g:form resource="${this.rewards}" method="PUT">
                                    <g:hiddenField name="version" value="${this.rewards?.version}" />
