...
<html>
    <head>
        ...
        <g:set var="entityName" value="${message(code: 'experiences.label', default: 'Experiences')}" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="show-experiences" >
                                    ...
                                    <f:display bean="experiences" />
                                    <g:form class="form-horizontal" resource="${this.experiences}" method="DELETE">
                                        <fieldset class="buttons">
                                            <g:link class="btn btn-primary m-b-5 m-t-5" action="edit" resource="${this.experiences}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
