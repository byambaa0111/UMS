...
<html>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <f:table id="experiencesTable" maxProperties="3"  collection="${experiencesList}" except="['id','isActive']"/>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script type="application/javascript">
        var url = '/experiences/data_for_datatable';
                ...
                "columns": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<a href="/experiences/show/' + row.id + '">' + data + '</a>';
                        }
                    },
                    {"data": "position"},
                    {"data": "jobType"}
