        ...
        <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                            <div id="edit-sysGroup" >
                                <g:if test="${flash.message}">
                                <div class="message" role="status">${flash.message}</div>
                                </g:if>
                                <g:hasErrors bean="${this.sysGroup}">
                                <ul class="errors" role="alert">
                                    <g:eachError bean="${this.sysGroup}" var="error">
                                    <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                                    </g:eachError>
                                </ul>
                                </g:hasErrors>
                                <g:form resource="${this.sysGroup}" method="PUT">
                                    <g:hiddenField name="version" value="${this.sysGroup?.version}" />
                                    <div class="form-group row">
                                        <f:all bean="sysGroup" except="sysGroupMenus"/>
                                    </div>
