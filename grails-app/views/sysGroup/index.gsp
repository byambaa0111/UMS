...
<html>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <f:table id="sysGroupTable" maxProperties="2" collection="${sysGroupList}" except="['id','isActive']"/>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script type="application/javascript">
        var url = '/sysGroup/data_for_datatable';
                ...
                "columns": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<a href="/sysGroup/show/' + row.id + '">' + data + '</a>';
                        }
                    },
                    {"data": "groupDesc"}
