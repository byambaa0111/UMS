        ...
        <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                            <div id="edit-sysGroupMenuPermission" >
                                <g:if test="${flash.message}">
                                <div class="message" role="status">${flash.message}</div>
                                </g:if>
                                <g:hasErrors bean="${this.sysGroupMenuPermission}">
                                <ul class="errors" role="alert">
                                    <g:eachError bean="${this.sysGroupMenuPermission}" var="error">
                                    <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                                    </g:eachError>
                                </ul>
                                </g:hasErrors>
                                <g:form resource="${this.sysGroupMenuPermission}" method="PUT">
                                    <g:hiddenField name="version" value="${this.sysGroupMenuPermission?.version}" />
                                    <div class="form-group row">
                                        <f:all bean="sysGroupMenuPermission"/>
                                    </div>
