...
<html>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <f:table id="sysGroupMenuPermissionTable"  collection="${sysGroupMenuPermissionList}" except="['id','isActive']"/>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script type="application/javascript">
        var url = '/sysGroupMenuPermission/data_for_datatable';
                ...
                "columns": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<a href="/sysGroupMenuPermission/show/' + row.id + '">' + data + '</a>';
                        }
                    },
                    {"data": "version"},
