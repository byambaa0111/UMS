...
<html>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <f:table id="universityTable"  maxProperties="3" collection="${universityList}" except="['id','isActive']"/>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script type="application/javascript">
        var url = '/university/data_for_datatable';
                ...
                "columns": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<a href="/university/show/' + row.id + '">' + data + '</a>';
                        }
                    },
                    {"data": "universityNameEn"},
                    {"data": "universityShortName"}
