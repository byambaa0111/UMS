...
<html>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <f:table id="FLanguagesTable"  collection="${FLanguagesList}" except="['id','isActive']"/>
                        %{--<div class="pagination">
                            <g:paginate total="${FLanguagesCount ?: 0}" />
                        </div>--}%
    ...
    <script type="application/javascript">
        var url = '/FLanguages/data_for_datatable';
                ...
                "columns": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<a href="/FLanguages/show/' + row.id + '">' + data + '</a>';
                        }
                    },
                    {"data": "language"},
                    {"data": "reading"},
