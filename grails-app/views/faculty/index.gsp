...
<html>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <f:table id="facultyTable"  maxProperties="5" collection="${facultyList}" except="['id','isActive']"/>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script type="application/javascript">
        var url = '/faculty/data_for_datatable';
                ...
                "columns": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<a href="/faculty/show/' + row.id + '">' + data + '</a>';
                        }
                    },
                    {"data": "phoneNumber"},
                    {"data": "type"},
