                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="show-sysMenu" >
                                    ...
                                    <f:display bean="sysMenu" />
                                    <g:form class="form-horizontal" resource="${this.sysMenu}" method="DELETE">
                                        <fieldset class="buttons">
                                            <g:link class="btn btn-primary m-b-5 m-t-5" action="edit" resource="${this.sysMenu}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
