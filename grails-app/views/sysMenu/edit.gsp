                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div id="edit-sysMenu" >
                                ...
                                <g:hasErrors bean="${this.sysMenu}">
                                <ul class="errors" role="alert">
                                    <g:eachError bean="${this.sysMenu}" var="error">
                                    <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                                    </g:eachError>
                                </ul>
                                </g:hasErrors>
                                <g:form resource="${this.sysMenu}" method="PUT">
                                    <g:hiddenField name="version" value="${this.sysMenu?.version}" />
