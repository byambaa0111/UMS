                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div id="edit-coursesInPlan" >
                                ...
                                <g:form resource="${this.coursesInPlan}" method="PUT">
                                    <g:hiddenField name="version" value="${this.coursesInPlan?.version}" />
                                    <div class="form-group row">
                                        <f:all bean="coursesInPlan" except="department"/>
                                    </div>
