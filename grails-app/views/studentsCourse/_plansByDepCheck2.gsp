...
%{--Тухайн тэнхэмын бүх сургалтын төлөвлөгөөнүүдийг select/table хэлбэрээр гаргаж байна.--}%
...
<div class="form-group custom-switches-stacked">
    ...
    <g:elseif test="${programmePlans.size() >= 5}">
        <g:select  from="${programmePlans}"  optionKey="id" onchange="loadCourse(this.value)"
                   name="programmePlans" data-placeholder="Select a faculty"
...
<script>
    ...
    function loadCourse(id){
        ...
        $.ajax({
            type: "POST",
            url: url,
            data:  { 'programmePlanId': id,'isTable':"${isTable}" }, // serializes the form's elements.
