    ...
    <div class="header" >
        <table width="792" class="sample">
            <tr >
                <td align="center"><img src="${resource(dir:'images',file:'logoMnu.jpg')}" alt="String" height="93" width="103" border="0" /> </td>
            </tr>
            <tr >
            ...
            <tr >
                <td align="center">
                    ${this.teacher?.firstName} овогтой ${this.teacher?.lastName}  нь МҮИС-ийн бүрэлдэхүүн
                    " ${this.teacher.familyName} " -ийн "${this.teacher.teacherType}" албан тушаалд ажилладаг нь үнэн болохыг тодорхойлж байна..
                </td>
            </tr>
            <tr><td align="center">
                <br>  <br>
                <br>    <br>
                ХҮНИЙ НӨӨЦИЙН АЛБАНЫ ДАРГА : ........................../O.Энхзул/
