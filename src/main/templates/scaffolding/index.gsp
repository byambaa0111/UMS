...
<html>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <f:table id="${propertyName}Table"  collection="\${${propertyName}List}" except="['id','isActive']"/>
    ...
    <script type="application/javascript">
        var url = '/${propertyName}/data_for_datatable';
                ...
                "columns": [
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<a href="/${propertyName}/show/' + row.id + '">' + data + '</a>';
                        }
                    },
                    {"data": "version"},
